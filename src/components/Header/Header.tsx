...
const Header: React.FC = () => {
  return (
    <div className="sticky top-0 flex flex-col items-center w-full z-[55] px-6 py-4 shadow bg-base-100 justify-center outline outline-1">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1540 747"
        className="fill-neutral-content mb-2 w-16"
      >
      ...
      <h2 className="font-display font-bold text-xl text-primary">winnow</h2>
      <div className="flex gap-4">
        {routes.map((route) => (
          <Link to={route.path} key={route.key} className="hover:outline">
            {route.name}
          </Link>
        ))}
      </div>
